        ...
        describe("using " + parser + " and " + ip, function () {
            ...
            describe('enable_offline_queue', function () {
                describe('true', function () {
                    ...
                    it("replace the minimum timeout if the timeout is below the reconnect delay time", function () {
                        client = redis.createClient({
                            enable_offline_queue: 5,
                            parser: parser
                        });
                        assert.strictEqual(client.enable_offline_queue, client.retry_delay + 50);
                    });
